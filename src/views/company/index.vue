<template>
  <div class="app-container">
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="Loading" border fit highlight-current-row>
      <el-table-column align="center" label='組織\單位名稱' width="95">
        <template slot-scope="scope">
          {{scope.$index}}
        </template>
      </el-table-column>
      <el-table-column label="聯絡人姓名">
        <template slot-scope="scope">
          {{scope.row.title}}
        </template>
      </el-table-column>
      ...
      <el-table-column class-name="status-col" label="服務地區類別" width="110" align="center">
        <template slot-scope="scope">
